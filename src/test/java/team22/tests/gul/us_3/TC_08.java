...
public class TC_08 {
    ...
    //Kullanici email adrsini siler
    //Kullanici SAVE ADDRESS alanina tiklar .
    //Kullanici " Email address is a required fiel." mesajini gorur.

    HomepageGul homepageGul=new HomepageGul();
    @Test
    public void testEmail_negative() {
        ...
        //Kullanici email adrsini siler
        homepageGul.email.clear();

        //Kullanici SAVE ADDRESS alanina tiklar .
        ReusableMethods.clickByJS(homepageGul.saveAdresse);

        //Kullanici " Email address is a required field." mesajini gorur.
        ReusableMethods.getScreenshot("NegativeEmail");
        ReusableMethods.waitFor(2);
        Assert.assertEquals(homepageGul.ereurMessage.getText(),"Email address is a required field.");
