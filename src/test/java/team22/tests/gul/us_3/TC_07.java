...
public class TC_07 {
    ...
    //Kullanici Phone bolumunu bos birakir
    //Kullanici email adrsinin otomatik geldigini gorur
    //Kullanici SAVE ADDRESS alanina tiklar .
    //Kullanici " Phone is a required field." mesajini gorur.
    ...
    public void testPhone_negative() {
        ...
        //Kullanici Phone alanini bos birakir
        ...
        //Kullanici " Phone is a required field." mesajini gorur.
        ReusableMethods.getScreenshot("NegatiPhone");
        ReusableMethods.waitFor(2);
