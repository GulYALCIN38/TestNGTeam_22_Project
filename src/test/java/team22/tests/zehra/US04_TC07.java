...
public class US04_TC07 {
    //TOWN/CITY ALANININ BOS BIRAKILMASI
    ...
    public void TC007() {
        ...
        ReusableMethods.getScreenshot("us04 tc07");
        ReusableMethods.waitFor(3);
        Assert.assertEquals(allureMyAccount.errorMessage.getText(),"Town / City is a required field.");
        Driver.closeDriver();
