...
public class US04_TC06 {
    //POSTCODE/ZIP ALANININ BOS BIRAKILMASI
    ...
    public void TC001() {
        ...
        ReusableMethods.getScreenshot("US04 TC06");
        ReusableMethods.waitFor(2);
        Assert.assertEquals(allureMyAccount.errorMessage.getText(),"Postcode / ZIP is a required field.");
        Driver.closeDriver();
